    ...
    override func spec() {
        ...
        describe("GetFormFields") {
            ...
            it("Test_004_Success") {
                ...
                var actualFieldCodes: [String] = []
                for (_, value) in result.getProperties()! {
                    actualFieldCodes.append(value.getCode())
                }
                expect(actualFieldCodes).to(contain(TestConstant.InitData.FIELD_CODES))
            }
            ...
            it("Test_008_Success_IsPreviewTrue") {
