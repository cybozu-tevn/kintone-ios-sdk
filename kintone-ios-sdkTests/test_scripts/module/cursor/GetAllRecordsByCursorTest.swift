        ...
        describe("GetAllRecordsByCursor") {
           ...
           it("Test_055_Success_ValidRequest_GetRecordsIsCorrectly") {
            ...
            it("Test_062_Error_WithoutViewRecordsPermissionOnRecord") {
                ...
                let user1Permission = RightEntity(entity: DevMemberEntity(DevMemberType.USER, "user1"), viewable: false, editable: false, deletable: false)
            ...
            func _getDefaultPermissionOfRecord () -> [RightEntity] {
                ...
                let user4Permission = RightEntity(entity: DevMemberEntity(DevMemberType.USER, "user4"), viewable: true, editable: true, deletable: false)
