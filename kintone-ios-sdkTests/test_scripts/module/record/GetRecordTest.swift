...
class GetRecordTest: QuickSpec {
    ...
    let USERNAME_WITHOUT_VIEW_FIELD_PERMISSION = TestConstant.Connection.CRED_USERNAME_WITHOUT_VIEW_FIELD_PEMISSION
    let PASSWORD_WITHOUT_VIEW_FIELD_PERMISSION = TestConstant.Connection.CRED_PASSWORD_WITHOUT_VIEW_FIELD_PEMISSION
