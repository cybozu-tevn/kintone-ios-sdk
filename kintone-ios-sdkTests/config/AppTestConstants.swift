...
public class AppTestConstants {
    public static let COMMON_APP_ID = 1
    
    public static let GET_APPS_OFFSET = 1
    ...
    public static let GET_APPS_BY_CODES_APP_CODES = ["xxxx"]
    
    public static let GET_APPS_BY_IDs_APP_IDs = [1]
    ...
    public static let GET_APPS_BY_NAME_APP_NAME = "xxxx"
    ...
    public static let GET_APP_DEPLOY_STATUS_APP_IDS = [1, 1]
